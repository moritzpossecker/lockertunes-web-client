        ...
        <>
            {progress == 0 &&
                <GetLeagueTeamsForm
                    ...
                    leagueUrl={leagueUrl} setLeagueUrl={setLeagueUrl}
                />
            }
            {progress == 1 &&
                <GetTeamForm
                    changeProgress={changeProgress}
                    team={team}
                    teams={teams} setTeam={setTeam}
                />
            }
            {progress == 2 &&
                <GetGameSpan setMatches={setMatches} changeProgress={changeProgress}
                    leagueUrl={leagueUrl} team={team}
                />
            }
            {progress == 3 &&
                <TeamsCarousel
