...
import {z} from "zod"
import {ArrowRightIcon, CheckCircledIcon, MagnifyingGlassIcon, SymbolIcon} from "@radix-ui/react-icons";
...
const GetLeagueTeamsForm: React.FC<GetLeagueTeamsProps> = ({changeProgress, teams, setTeams, leagueUrl, setLeagueUrl}) => {
