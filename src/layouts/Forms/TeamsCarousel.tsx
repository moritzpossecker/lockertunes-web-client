...
const TeamsCarousel: React.FC<TeamsCarousel> = ({changeProgress, matches, setMatches}) => {
                                    ...
                                    <Card className="mt-3 relative">
                                        ...
                                        <CardContent className="flex aspect-square items-center justify-center p-6">
                                            <div className="flex flex-col gap-4 items-center">
                                                ...
                                                <div
                                                    className="text-gray-300 text-center min-h-14">{match.opponent}</div>
                                                <div
                                                    className="text-sm font-light text-gray-500 flex items-center gap-2">
                                                    <CalendarIcon/>{getMatchDayString(match.match_day)} match
                                                </div>
                                            </div>
                                        </CardContent>
                                    </Card>
